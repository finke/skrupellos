    ...
    public function __construct($lvl = ''){
        ...
        if(version_compare(PHP_VERSION, '5.3.0', '<')){    //Prüfen welche Hash Funktionen Verfügbar sind. Ab 5.3 werden alle Mitgeliefert
            ...
            if($this->hashAlgorithm == self::BLOWFISH && !defined('CRYPT_BLOWFISH') && CRYPT_BLOWFISH !== 1){
				...
				trigger_error(htmlentities("Es wurde der MD5 Hash-Algorithmus gewählt (Auswahl oder da höhere nciht verfügbar).\n Dies ist ein sehr unsicherer Algorithmus. Wir empfehlen Ihnen, einen wenn möglcih einen stärkeren Algorithmus zu Wählen."), E_USER_NOTICE);
            }
        }
    }
